...
pub struct RepaymentResponseWithClientInfo {
...
impl RepaymentResponseWithClientInfo {
    pub fn builder() -> RepaymentResponseWithClientInfoBuilder {
        <RepaymentResponseWithClientInfoBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RepaymentResponseWithClientInfoBuilder {
    id: Option<String>,
...
impl RepaymentResponseWithClientInfoBuilder {
    ...
    /// Consumes the builder and constructs a [`RepaymentResponseWithClientInfo`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](RepaymentResponseWithClientInfoBuilder::id)
    /// - [`created_at`](RepaymentResponseWithClientInfoBuilder::created_at)
    /// - [`client_id`](RepaymentResponseWithClientInfoBuilder::client_id)
    /// - [`loan_id`](RepaymentResponseWithClientInfoBuilder::loan_id)
    /// - [`installment_id`](RepaymentResponseWithClientInfoBuilder::installment_id)
    /// - [`amount`](RepaymentResponseWithClientInfoBuilder::amount)
    pub fn build(self) -> Result<RepaymentResponseWithClientInfo, BuildError> {
        Ok(RepaymentResponseWithClientInfo {
