...
impl InstallmentResponse {
    pub fn builder() -> InstallmentResponseBuilder {
        <InstallmentResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct InstallmentResponseBuilder {
    id: Option<String>,
...
impl InstallmentResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`InstallmentResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](InstallmentResponseBuilder::id)
    /// - [`created_at`](InstallmentResponseBuilder::created_at)
    /// - [`updated_at`](InstallmentResponseBuilder::updated_at)
    /// - [`partner_id`](InstallmentResponseBuilder::partner_id)
    /// - [`client_id`](InstallmentResponseBuilder::client_id)
    /// - [`currency`](InstallmentResponseBuilder::currency)
    /// - [`status`](InstallmentResponseBuilder::status)
    /// - [`loan_id`](InstallmentResponseBuilder::loan_id)
    /// - [`amount`](InstallmentResponseBuilder::amount)
    /// - [`expected_repayment_at`](InstallmentResponseBuilder::expected_repayment_at)
    /// - [`installment_number`](InstallmentResponseBuilder::installment_number)
    /// - [`installments`](InstallmentResponseBuilder::installments)
    /// - [`principal`](InstallmentResponseBuilder::principal)
    /// - [`interest`](InstallmentResponseBuilder::interest)
    pub fn build(self) -> Result<InstallmentResponse, BuildError> {
        Ok(InstallmentResponse {
