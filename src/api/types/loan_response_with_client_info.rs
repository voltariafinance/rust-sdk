...
pub struct LoanResponseWithClientInfo {
    /// The ID of the loan
    #[serde(default)]
    pub id: String,
...
impl LoanResponseWithClientInfo {
    pub fn builder() -> LoanResponseWithClientInfoBuilder {
        <LoanResponseWithClientInfoBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct LoanResponseWithClientInfoBuilder {
    id: Option<String>,
...
impl LoanResponseWithClientInfoBuilder {
    ...
    /// - [`created_at`](LoanResponseWithClientInfoBuilder::created_at)
    /// - [`updated_at`](LoanResponseWithClientInfoBuilder::updated_at)
    /// - [`partner_id`](LoanResponseWithClientInfoBuilder::partner_id)
    /// - [`client_id`](LoanResponseWithClientInfoBuilder::client_id)
    /// - [`currency`](LoanResponseWithClientInfoBuilder::currency)
    /// - [`amount`](LoanResponseWithClientInfoBuilder::amount)
    /// - [`status`](LoanResponseWithClientInfoBuilder::status)
    /// - [`currency_rate`](LoanResponseWithClientInfoBuilder::currency_rate)
    /// - [`client`](LoanResponseWithClientInfoBuilder::client)
    pub fn build(self) -> Result<LoanResponseWithClientInfo, BuildError> {
        Ok(LoanResponseWithClientInfo {
