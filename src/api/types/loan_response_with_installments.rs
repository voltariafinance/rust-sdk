...
pub struct LoanResponseWithInstallments {
    /// The ID of the loan
    #[serde(default)]
    pub id: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub installments: Option<Vec<LoanInstallmentResponse>>,
}

impl LoanResponseWithInstallments {
    pub fn builder() -> LoanResponseWithInstallmentsBuilder {
        <LoanResponseWithInstallmentsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct LoanResponseWithInstallmentsBuilder {
    id: Option<String>,
    ...
    installments: Option<Vec<LoanInstallmentResponse>>,
}

impl LoanResponseWithInstallmentsBuilder {
    ...
    pub fn installments(mut self, value: Vec<LoanInstallmentResponse>) -> Self {
        self.installments = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`LoanResponseWithInstallments`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](LoanResponseWithInstallmentsBuilder::id)
    /// - [`created_at`](LoanResponseWithInstallmentsBuilder::created_at)
    /// - [`updated_at`](LoanResponseWithInstallmentsBuilder::updated_at)
    /// - [`partner_id`](LoanResponseWithInstallmentsBuilder::partner_id)
    /// - [`client_id`](LoanResponseWithInstallmentsBuilder::client_id)
    /// - [`currency`](LoanResponseWithInstallmentsBuilder::currency)
    /// - [`amount`](LoanResponseWithInstallmentsBuilder::amount)
    /// - [`status`](LoanResponseWithInstallmentsBuilder::status)
    /// - [`currency_rate`](LoanResponseWithInstallmentsBuilder::currency_rate)
    pub fn build(self) -> Result<LoanResponseWithInstallments, BuildError> {
        Ok(LoanResponseWithInstallments {
