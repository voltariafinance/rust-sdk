...
/// Query parameters for investor_list_repayments
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq, Eq, Hash)]
pub struct InvestorListRepaymentsQueryRequest {
...
impl InvestorListRepaymentsQueryRequest {
    pub fn builder() -> InvestorListRepaymentsQueryRequestBuilder {
        <InvestorListRepaymentsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct InvestorListRepaymentsQueryRequestBuilder {
...
impl InvestorListRepaymentsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`InvestorListRepaymentsQueryRequest`].
    pub fn build(self) -> Result<InvestorListRepaymentsQueryRequest, BuildError> {
        Ok(InvestorListRepaymentsQueryRequest {
