...
## Tasks
<details><summary><code>client.tasks.<a href="/src/api/resources/tasks/client.rs">list_tasks</a>(status: Option&lt;Option&lt;Option&lt;TaskStatusEnum&gt;&gt;&gt;, client_id: Option&lt;Option&lt;Option&lt;String&gt;&gt;&gt;, loan_id: Option&lt;Option&lt;Option&lt;String&gt;&gt;&gt;, installment_id: Option&lt;Option&lt;Option&lt;String&gt;&gt;&gt;, waterfall_id: Option&lt;Option&lt;Option&lt;String&gt;&gt;&gt;, page: Option&lt;Option&lt;i64&gt;&gt;, page_size: Option&lt;Option&lt;Option&lt;i64&gt;&gt;&gt;, order_by: Option&lt;Option&lt;Option&lt;String&gt;&gt;&gt;, q: Option&lt;Option&lt;Option&lt;String&gt;&gt;&gt;) -> Result&lt;PaginatedResponseTaskPartnerResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
**status:** `Option<Option<TaskStatusEnum>>` — Filter by task status.
...
**client_id:** `Option<Option<String>>` — Filter by client.
...
**loan_id:** `Option<Option<String>>` — Filter by loan.
...
**installment_id:** `Option<Option<String>>` — Filter by installment.
...
**waterfall_id:** `Option<Option<String>>` — Filter by waterfall.
...
**order_by:** `Option<Option<String>>` — Field to order the results by, e.g., 'due_at:asc,created_at:desc'.
...
**q:** `Option<Option<String>>` — Query string for filtering. Format: "field:operator:value;...". Supported fields: id, status, priority, due_at, created_at, client_id, loan_id, installment_id, waterfall_id. Supported operators: is, in, not_in, contains, not_contains, like, not_like, ilike, not_ilike, gt, gte, lt, lte, starts_with, ends_with, is_null, is_not_null.
...
<details><summary><code>client.tasks.<a href="/src/api/resources/tasks/client.rs">create_task</a>(request: TaskPartnerCreatePayload) -> Result&lt;TaskPartnerResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
async fn main() {
    ...
    client
        .tasks
        .create_task(
            &TaskPartnerCreatePayload {
                title: "Send updated bank statement".to_string(),
                description: None,
                priority: None,
                due_at: None,
                client_id: None,
...
**description:** `Option<Option<String>>` — Optional longer description of what needs to be done.
...
**priority:** `Option<Option<TaskPriorityEnum>>` — Task priority. One of the following: low, medium, high, urgent
...
**due_at:** `Option<Option<String>>` — Optional due date for the task.
...
**client_id:** `Option<Option<String>>` — Client this task relates to. Must belong to your partner account.
...
**loan_id:** `Option<Option<String>>` — Loan this task relates to. Must belong to your partner account.
...
**installment_id:** `Option<Option<String>>` — Installment this task relates to. Must belong to your partner account.
...
**waterfall_id:** `Option<Option<String>>` — Waterfall this task relates to. Must belong to your partner account.
...
<details><summary><code>client.tasks.<a href="/src/api/resources/tasks/client.rs">get_task</a>(task_id: String) -> Result&lt;TaskPartnerResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
async fn main() {
    ...
    let client = ApiClient::new(config).expect("Failed to build client");
    client.tasks.get_task(&"task_id".to_string(), None).await;
}
```
</dd>
</dl>
...
<details><summary><code>client.tasks.<a href="/src/api/resources/tasks/client.rs">update_task_status</a>(task_id: String, request: TaskPartnerStatusUpdatePayload) -> Result&lt;TaskPartnerResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
async fn main() {
    ...
    client
        ...
        .update_task_status(
            &"task_id".to_string(),
            &TaskPartnerStatusUpdatePayload {
...
<details><summary><code>client.tasks.<a href="/src/api/resources/tasks/client.rs">list_task_status_history</a>(task_id: String, page: Option&lt;Option&lt;i64&gt;&gt;, page_size: Option&lt;Option&lt;Option&lt;i64&gt;&gt;&gt;, order_by: Option&lt;Option&lt;Option&lt;String&gt;&gt;&gt;) -> Result&lt;PaginatedResponseTaskPartnerStatusHistoryResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
async fn main() {
    ...
    client
        ...
        .list_task_status_history(
            &"task_id".to_string(),
            &ListTaskStatusHistoryQueryRequest {
                ..Default::default()
            },
            None,
        )
...
**order_by:** `Option<Option<String>>` — Field to order the results by, e.g., 'created_at:asc'. Defaults to 'created_at:desc'.
...
<details><summary><code>client.tasks.<a href="/src/api/resources/tasks/client.rs">list_task_notes</a>(task_id: String, page: Option&lt;Option&lt;i64&gt;&gt;, page_size: Option&lt;Option&lt;Option&lt;i64&gt;&gt;&gt;, order_by: Option&lt;Option&lt;Option&lt;String&gt;&gt;&gt;, q: Option&lt;Option&lt;Option&lt;String&gt;&gt;&gt;) -> Result&lt;PaginatedResponseNoteResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
**order_by:** `Option<Option<String>>` — Field to order the results by, e.g., 'created_at:desc'. Defaults to 'created_at:desc'.
...
**q:** `Option<Option<String>>` — Query string for filtering. Format: "field:operator:value;...". Supported fields: id, loan_id, installment_id, created_at. Supported operators: is, in, not_in, contains, not_contains, like, not_like, ilike, not_ilike, gt, gte, lt, lte, starts_with, ends_with, is_null, is_not_null.
...
<details><summary><code>client.tasks.<a href="/src/api/resources/tasks/client.rs">create_task_note</a>(task_id: String, request: TaskNoteCreatePayload) -> Result&lt;NoteResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
async fn main() {
    ...
    client
        ...
        .create_task_note(
            &"task_id".to_string(),
            &TaskNoteCreatePayload {
                content: "Statement uploaded, please re-check.".to_string(),
            },
            None,
        )
        .await;
